package com.n2n.letsgo.TypeReView;
...
public class Word_Picture_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Records(strID) > 0) {
            ...
            Toast.makeText(Word_Picture_activity.this, "No records to show", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void CheckChooseAnswer() {
        ...
        if (rbtAnswer1.isChecked()) {
            ...
            if (answer.equals(Answer)) {
                ...
                Toast.makeText(Word_Picture_activity.this, "You are wrong! Please, try again", Toast.LENGTH_SHORT).show();
            }
        }
